...
public class Level6 extends Level{
	...
	public Level6(String path, StateManager manager){
		super(path, manager);
	}
	...
	public void generateLevel(){
		...
		spawnX = levelX + 30*3+5;
		spawnY = levelY + 30*10+5;
		entities.add(new Player(this, spawnX, spawnY));
		
		entities.add(new Item(this, levelX + 30*5+7, levelY + 30*6+7, 1));
		entities.add(new Item(this, levelX + 30*13+7, levelY + 30*9+7, 1));
		entities.add(new Item(this, levelX + 30*17+7, levelY + 30*7+7, 1));
		entities.add(new Item(this, levelX + 30*21+7, levelY + 30*7+7, 0));
		
		entities.add(new Walker(this, levelX+30*3+3, levelY+30*14+3, 1, 1, 30*6));
		entities.add(new Walker(this, levelX+30*17+3, levelY+30*7+3, 2, 2, 30*3));
		entities.add(new Walker(this, levelX+30*19+3, levelY+30*5+3, 1, 1, 30*6));
	}
	...
	public void update2(){
		if(start){
			...
			if(endY <= -1200){
				manager.setLevel(new Level7("/levels/level7.png", manager));
			}
		}else{
			updateEntities();
