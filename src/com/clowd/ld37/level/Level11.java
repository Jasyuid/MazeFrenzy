...
public class Level11 extends Level{
	...
	public Level11(String path, StateManager manager){
		super(path, manager);
	}
	...
	public void generateLevel(){
		...
		spawnX = levelX + 30*8+5;
		spawnY = levelY + 30*3+5;
		entities.add(new Player(this, spawnX, spawnY));
		
		entities.add(new Item(this, levelX + 30*13+7, levelY + 30*10+7, 0));
		entities.add(new Item(this, levelX + 30*16+7, levelY + 30*6+7, 1));
		entities.add(new Item(this, levelX + 30*8+7, levelY + 30*15+7, 2));
		entities.add(new Item(this, levelX + 30*10+7, levelY + 30*15+7, 2));
		entities.add(new Item(this, levelX + 30*12+7, levelY + 30*15+7, 2));
		
		entities.add(new Walker(this, levelX+30*14+3, levelY+30*10+3, 0, 1, 30*4));

		entities.add(new Trap(this, levelX+30*11, levelY+30*11, 0));
		entities.add(new Trap(this, levelX+30*16, levelY+30*14, 0));
		entities.add(new Trap(this, levelX+30*20, levelY+30*5, 0));
		entities.add(new Trap(this, levelX+30*21, levelY+30*6, 0));
		entities.add(new Trap(this, levelX+30*13, levelY+30*3, 0));
	}
	...
	public void update2(){
		if(start){
			...
			if(endY <= -1200){
				manager.setLevel(new Level12("/levels/level12.png", manager));
			}
		}else{
			updateEntities();
