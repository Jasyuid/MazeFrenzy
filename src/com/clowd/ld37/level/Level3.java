...
public class Level3 extends Level{
	...
	public Level3(String path, StateManager manager){
		super(path, manager);
	}
	...
	public void generateLevel(){
		...
		entities.add(new Item(this, levelX + 30*10+7, levelY + 30*6+7, 1));
		entities.add(new Item(this, levelX + 30*19+7, levelY + 30*6+7, 1));
		entities.add(new Item(this, levelX + 30*10+7, levelY + 30*15+7, 1));
}
	...
	public void update2(){
		if(start){
			...
			if(endY <= -1200){
				manager.setLevel(new Level4("/levels/level4.png", manager));
			}
		}else{
			updateEntities();
