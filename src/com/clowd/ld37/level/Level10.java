...
public class Level10 extends Level{
	...
	public Level10(String path, StateManager manager){
		super(path, manager);
	}
	...
	public void generateLevel(){
		...
		spawnX = levelX + 30*23+5;
		spawnY = levelY + 30*15+5;
		entities.add(new Player(this, spawnX, spawnY));
		
		entities.add(new Item(this, levelX + 30*23+7, levelY + 30*5+7, 0));
		entities.add(new Item(this, levelX + 30*8+7, levelY + 30*5+7, 0));
		entities.add(new Item(this, levelX + 30*9+7, levelY + 30*12+7, 1));
		entities.add(new Item(this, levelX + 30*23+7, levelY + 30*13+7, 1));
		entities.add(new Item(this, levelX + 30*8+7, levelY + 30*7+7, 2));
		entities.add(new Item(this, levelX + 30*7+7, levelY + 30*3+7, 2));
		
		entities.add(new Walker(this, levelX+30*5+3, levelY+30*12+3, 1, 1, 30*4));
		entities.add(new Walker(this, levelX+30*21+3, levelY+30*5+3, 1, 3, 30*7));
		
		entities.add(new Trap(this, levelX+30*12, levelY+30*3, 0));
	}
	...
	public void update2(){
		if(start){
			...
			if(endY <= -1200){
				manager.setLevel(new Level11("/levels/level11.png", manager));
			}
		}else{
			updateEntities();
